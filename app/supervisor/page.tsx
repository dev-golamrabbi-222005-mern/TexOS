...
export default function SupervisorDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#090d16] text-slate-100 p-6 flex flex-col items-center justify-center">
      <div className="max-w-xl w-full glass-panel p-8 rounded-2xl shadow-xl border border-amber-500/20 text-center">
        <div className="w-16 h-16 bg-amber-500/10 border border-amber-500/30 text-amber-400 rounded-2xl mx-auto flex items-center justify-center mb-4">
        ...
        <h1 className="text-3xl font-extrabold mt-4 text-white">
          Welcome, {session?.user?.fullName || 'Line Supervisor'}!
        </h1>
        <p className="text-slate-400 text-sm mt-2">
          Bundle Movement & Production Tracking Scanning Terminal
        </p>
